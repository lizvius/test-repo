      ...
      <GlassCard className="border-sky-500/20 shadow-2xl">
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div className="flex flex-col gap-1.5">
            <label className="text-xs font-bold tracking-wider text-slate-300 uppercase px-1">
            ...
            <textarea
              ...
              className="w-full rounded-2xl py-3 px-4 text-sm font-medium outline-none border border-slate-700/60 bg-slate-900/80 focus:border-sky-500 focus:ring-2 focus:ring-sky-500/20 text-white transition-all placeholder:text-slate-500"
            />
          </div>
