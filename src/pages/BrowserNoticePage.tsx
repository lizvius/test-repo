...
export const BrowserNoticePage: React.FC = () => {
  return (
    <div className="min-h-screen bg-slate-950 flex flex-col items-center justify-center p-5 text-center text-slate-100">
      <GlassCard className="max-w-md w-full p-6 space-y-6 border-sky-500/30 shadow-2xl">
        <div className="flex justify-center">
          <AzurLizeLogo size="lg" />
        </div>

        <div className="w-16 h-16 rounded-3xl bg-sky-500/10 border border-sky-500/30 flex items-center justify-center mx-auto text-sky-400 text-3xl">
          📱
        </div>
