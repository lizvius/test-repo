      ...
      <GlassCard className="max-w-md w-full p-6 space-y-6 border-sky-500/30 shadow-2xl">
        ...
        <div className="space-y-2">
          ...
          <p className="text-xs text-slate-300 leading-relaxed">
            Anda sudah terdaftar dalam sistem rekrutmen <strong className="text-sky-400 font-bold">AzurLizeTeam</strong>. Silakan lanjutkan login untuk mengakses dasbor Anda.
          </p>
        </div>

        {/* Saved Session Info */}
        {(lastTgUser || lastProfile) && (
          <div className="bg-slate-800/40 backdrop-blur-sm p-4 rounded-2xl border border-slate-700 flex items-center gap-3 text-left">
            {photoUrl ? (
              <img
                src={photoUrl}
                alt="Profile"
        ...
        <div className="pt-2 border-t border-slate-800 flex flex-col gap-3">
          ...
          <button
            ...
            className="text-xs font-semibold text-slate-400 hover:text-sky-400 transition-colors flex items-center justify-center gap-1.5 py-1.5"
          >
